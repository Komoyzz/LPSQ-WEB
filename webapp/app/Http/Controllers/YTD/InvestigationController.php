...
use App\Imports\YTD\MultipleInvestigation;
...
{
    public function investigationimport()
    {
        return view('Import.investigationimport');
    }

    public function investigationstore(Request $request)
    {
        try {
            DB::beginTransaction();

            Excel::import(new MultipleInvestigation, $request->file('excel'));
